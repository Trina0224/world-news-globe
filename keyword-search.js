(() => {
  ...
  style.textContent = `
    .keyword-control{position:absolute;z-index:9;left:24px;bottom:62px;display:flex;align-items:center;gap:6px;padding:7px 8px;border:1px solid rgba(255,255,255,.12);border-radius:13px;background:rgba(5,7,11,.78);backdrop-filter:blur(14px);box-shadow:0 8px 28px rgba(0,0,0,.22)}
    ...
    .keyword-apply,.keyword-clear{border:1px solid rgba(255,255,255,.14);border-radius:999px;color:var(--text);background:rgba(255,255,255,.05);cursor:pointer;font:inherit;font-size:10px;padding:5px 8px}
    ...
    @media(max-width:430px){.keyword-control{right:14px;left:14px;bottom:55px}.keyword-label{display:none}.keyword-input{width:auto;flex:1}.keyword-apply{padding:6px 9px}}
  `;
